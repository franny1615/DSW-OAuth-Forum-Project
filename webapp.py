...
def posts_to_html():
    ...
    try:
        for document in collection.find():
            ...
            post += '</td><td>{% if logged_in %}<form action="/deletePost" method="post"><button type="submit" name="delete" value="'+  str(document.get('_id')) +'" class="btn btn-danger">Delete</button></form>{% endif %}</td></tr></table>'
